...
+ [A C program that prints a string without using the printf() or puts() functions.The program returns 1](https://github.com/IanoNjuguna/alx-low_level_programming/blob/main/0x00-hello_world/101-quote)
